...
namespace Cassette {
    ...
    protected class TrackPositionRow : TrackRowW {
        ...
        public override void load_content () {
            // TrackPosition widget not yet migrated
            child = new TrackPlaceholder ();
        }
    }
    ...
    public class TrackList : Adw.Bin {
        ...
        [GtkChild]
        unowned Gtk.MenuButton sort_menu_button;
        [GtkChild]
        ...
        construct {
            ...
            if (adjustment != null) {
                ...
                section.append (_("name"), "tracklist.sort-name");
                section.append (_("artist"), "tracklist.sort-artists");
                section.append (_("album"), "tracklist.sort-album");
                section.append (_("duration"), "tracklist.sort-duration");
        ...
        void filter () {
            ...
            foreach (var track_row in sorted_rows) {
                if (search_entry.text == "") {
                    bool show_explicit = Application.app_settings.get_boolean ("explicit-visible");
                    bool show_child = Application.app_settings.get_boolean ("child-visible");
                    bool is_available = Application.app_settings.get_boolean ("available-visible");
        ...
        void load_chunk () {
            ...
            int track_number = window != null ? window.get_height () / 80 : 10;
