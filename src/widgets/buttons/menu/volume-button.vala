...
public class Cassette.VolumeButton : CustomMenuButton {
    ...
    construct {
        ...
        real_button.tooltip_text = _("Change volume");
        ...
        var tape_settings = Application.tape_settings;
        tape_settings.bind_property ("volume", this, "volume", BindingFlags.BIDIRECTIONAL | BindingFlags.SYNC_CREATE);
        tape_settings.bind_property ("mute", this, "mute", BindingFlags.BIDIRECTIONAL | BindingFlags.SYNC_CREATE);
    }
