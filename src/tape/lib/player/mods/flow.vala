...
public sealed class Tape.PlayerFlow : PlayerMode {
    ...
    public async bool init_async () throws CantUseError {
        ...
        station_tracks = yield root.yam_helper.start_new_session (station_id);
    ...
    public async void send_feedback (
        ...
        yield root.yam_helper.send_rotor_feedback (
            radio_session_id,
    ...
    async YaMAPI.Track? get_next_track_async () throws CantUseError {
        ...
        last_station_tracks = yield root.yam_helper.get_session_tracks (radio_session_id, track_ids);
